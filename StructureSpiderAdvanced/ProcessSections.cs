...
namespace StructureSpiderAdvanced
{
    public class ProcessSections
    {
        ...
        public void EnumerateRemoteSectionsAndModules(IntPtr process, Action<Section> callbackSection)
        {
            ...
            var c2 = (EnumerateRemoteModuleCallback)delegate (ref EnumerateRemoteModuleData data)
            {
            };
        ...
        public delegate void EnumerateRemoteSectionsAndModulesDelegate(IntPtr process, [MarshalAs(UnmanagedType.FunctionPtr)] EnumerateRemoteSectionCallback callbackSection, [MarshalAs(UnmanagedType.FunctionPtr)] EnumerateRemoteModuleCallback callbackModule);
